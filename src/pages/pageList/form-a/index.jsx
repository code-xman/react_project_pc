      ...
      <div className={props.className}>
        { formItemList.map((formItem, index) => {
            ...
            if (formItem.name === 'input') {
              ...
              formItemEle = <Select className={cn('flex-1')} showSearch >
              ...
              formItemEle = <Radio.Group buttonStyle="solid" className={cn('flex-1')} >
                {formItem.options.map((option) => {
                  return <Radio.Button value={option.value} key={option.value} >{option.text}</Radio.Button>
                })}
              </Radio.Group>
            }
            ...
            return (
              <div 
                ...
                className={cn('flex', 'y-center', 'a-form-item', {
                  'a-form-item-active': formParams.current.activeItem === formItem.name
                })} 
